...
const createRequestConfig = (method: Method, uri: string, body?: unknown): AxiosRequestConfig => {
...
const apiCall = async (method: Method, uri: string, cacheDuration: number | undefined, body?: unknown) => {
